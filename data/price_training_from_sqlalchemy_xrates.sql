WITH PricingRaw AS (SELECT `elife-data-warehouse-prod.ods.ride_ride_1`.id                                      AS ride_id,
                           `elife-data-warehouse-prod.ods.ride_ride_1`.trip_count,
                           `elife-data-warehouse-prod.ods.ride_ride_1`.inserted_at                             AS ride_inserted_at,
                           ...
                           `elife-data-warehouse-prod.ods.ride_dispatch_1`.inserted_at                         AS dispatch_inserted_at,
                           `elife-data-warehouse-prod.ods.ride_cur_exch_rate_history_1`.from_cur,
                           `elife-data-warehouse-prod.ods.ride_cur_exch_rate_history_1`.to_cur,
                           `elife-data-warehouse-prod.ods.ride_cur_exch_rate_history_1`.rate,
                           `elife-data-warehouse-prod.ods.ride_cur_exch_rate_history_1`.effective_at,
                           `elife-data-warehouse-prod.ods.ride_cur_exch_rate_history_1`.expire_at,
                           ...
                           anon_6.partner_id,
                           anon_6.partner,
                           anon_7.service_area_id,
                           anon_7.service_area,
                           anon_8.start_place_id,
                           anon_8.start_place,
                           anon_8.lng                                                                          AS start_lng,
                           anon_8.ltt                                                                          AS start_ltt,
                           anon_9.end_place_id,
                           anon_9.end_place,
                           anon_9.lng                                                                          AS end_lng,
                           anon_9.ltt                                                                          AS end_ltt,
                           anon_10.vehicle_class_id,
                           anon_10.vehicle_class,
                    ...
                    FROM `elife-data-warehouse-prod.ods.ride_ride` AS `elife-data-warehouse-prod.ods.ride_ride_1`
                             ...
                             JOIN (SELECT `elife-data-warehouse-prod.ods.ride_ride_1`.id                                                     AS ride_id,
                                          substring(`elife-data-warehouse-prod.ods.ride_ride_1`.from_time_str,
                                                    1,
                                                    10)                                                                                      AS from_date_str,
                                          concat(substring(`elife-data-warehouse-prod.ods.ride_ride_1`.from_time_str,
                                                           12, 16),
                                                 ':00')                                                                                      AS from_time_fix_str,
                                          concat(substring(`elife-data-warehouse-prod.ods.ride_ride_1`.from_time_str,
                                                           1, 10), ' ',
                                                 substring(`elife-data-warehouse-prod.ods.ride_ride_1`.from_time_str,
                                                           12, 16),
                             ...
                             LEFT OUTER JOIN (SELECT anon_11.ride_id                                  AS ride_id,
                                                     anon_11.trip_type_id                             AS trip_type_id,
                                                    ...
                                                    FROM `elife-data-warehouse-prod.ods.ride_dispatch` AS `elife-data-warehouse-prod.ods.ride_dispatch_1`
                                                             JOIN `elife-data-warehouse-prod.ods.ride_trip` AS `elife-data-warehouse-prod.ods.ride_trip_1`
                                                                  ON `elife-data-warehouse-prod.ods.ride_dispatch_1`.ride_id =
                                                                     `elife-data-warehouse-prod.ods.ride_trip_1`.ride_id) AS anon_11
                                                       LEFT OUTER JOIN `elife-data-warehouse-prod.ods.ride_enum` AS `elife-data-warehouse-prod.ods.ride_enum_1`
                                                                       ON anon_11.trip_type_id = `elife-data-warehouse-prod.ods.ride_enum_1`.id) AS anon_2
                             ...
                             LEFT OUTER JOIN (SELECT anon_12.ride_id                                     AS ride_id,
                                                     anon_12.partner_id                                  AS partner_id,
                                                    ...
                                                    FROM `elife-data-warehouse-prod.ods.ride_ride` AS `elife-data-warehouse-prod.ods.ride_ride_1`
                                                             LEFT OUTER JOIN `elife-data-warehouse-prod.ods.ride_partner_tran` AS `elife-data-warehouse-prod.ods.ride_partner_tran_1`
                                                                             ON `elife-data-warehouse-prod.ods.ride_ride_1`.partner_tran_id =
                                                                                `elife-data-warehouse-prod.ods.ride_partner_tran_1`.id) AS anon_12
                                                       LEFT OUTER JOIN `elife-data-warehouse-prod.ods.ride_partner` AS `elife-data-warehouse-prod.ods.ride_partner_1`
                                                                       ON anon_12.partner_id = `elife-data-warehouse-prod.ods.ride_partner_1`.id) AS anon_6
                                             ON `elife-data-warehouse-prod.ods.ride_ride_1`.id = anon_6.ride_id
                             JOIN (SELECT `elife-data-warehouse-prod.ods.ride_ride_1`.id              AS ride_id,
                                          `elife-data-warehouse-prod.ods.ride_ride_1`.service_area_id AS service_area_id,
                                          `elife-data-warehouse-prod.dim.dim_service_area_1`.name     AS service_area
                                   FROM `elife-data-warehouse-prod.ods.ride_ride` AS `elife-data-warehouse-prod.ods.ride_ride_1`
                                            JOIN `elife-data-warehouse-prod.dim.dim_service_area` AS `elife-data-warehouse-prod.dim.dim_service_area_1`
                                                 ON `elife-data-warehouse-prod.ods.ride_ride_1`.service_area_id =
                                                    `elife-data-warehouse-prod.dim.dim_service_area_1`.id) AS anon_7
                                              ...
                                              FROM `elife-data-warehouse-prod.ods.ride_ride` AS `elife-data-warehouse-prod.ods.ride_ride_1`
                                                       LEFT OUTER JOIN `elife-data-warehouse-prod.dim.dim_place` AS `elife-data-warehouse-prod.dim.dim_place_1`
                                                                       ON `elife-data-warehouse-prod.ods.ride_ride_1`.to_place_id =
                                                                          `elife-data-warehouse-prod.dim.dim_place_1`.id) AS anon_9
                                              ...
                                              FROM `elife-data-warehouse-prod.ods.ride_ride` AS `elife-data-warehouse-prod.ods.ride_ride_1`
                                                       LEFT OUTER JOIN `elife-data-warehouse-prod.ods.ride_vehicle_class` AS `elife-data-warehouse-prod.ods.ride_vehicle_class_1`
                                                                       ON `elife-data-warehouse-prod.ods.ride_ride_1`.vehicle_class_id =
                                                                          `elife-data-warehouse-prod.ods.ride_vehicle_class_1`.id) AS anon_10
                                             ON `elife-data-warehouse-prod.ods.ride_ride_1`.id = anon_10.ride_id,
                    ...
                    WHERE `elife-data-warehouse-prod.ods.ride_ride_1`.from_time_str
                      ...
                      AND `elife-data-warehouse-prod.ods.ride_cur_exch_rate_history_1`.to_cur =
                          `elife-data-warehouse-prod.ods.ride_dispatch_1`.currency)
SELECT *,
FROM PricingRaw
LIMIT 10
